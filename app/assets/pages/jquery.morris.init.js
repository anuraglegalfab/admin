...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#111444','#4eb7eb','#e3eaef']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b'], ["Bitcoin", "Ethereum"], ['#111444', "#e3eaef"]);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#111444','#0acf97', '#ebeff2']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#111444','#0acf97', '#ebeff2']);
    },
    //init

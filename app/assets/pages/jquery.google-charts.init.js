...
! function($) {
    ...
    GoogleChart.prototype.init = function () {
        ...
        $this.createAreaChart($('#area-chart')[0], common_data, 'Sales and Expenses', ['#e3eaef', '#111444']);
        ...
        $this.createColumnChart($('#column-chart')[0], column_data, 'Sales and Expenses', ['#111444','#0acf97', '#ebeff2']);
        ...
        $this.createColumnStackChart($('#column-stacked-chart')[0], column_stacked_data, 'Sales and Expenses', [ '#2d7bf4','#4eb7eb','#111444', '#e3eaef']);
        ...
        $this.createBarStackChart($('#bar-stacked-chart')[0], bar_stacked_data, ['#2d7bf4','#4eb7eb','#111444', '#e3eaef']);
        ...
        $this.createPieChart($('#pie-chart')[0], pie_data, ['#2d7bf4','#4eb7eb','#111444', '#e3eaef', '#32c861'], false, false);


        //creating donut chart
        $this.createDonutChart($('#donut-chart')[0], pie_data, ['#2d7bf4','#4eb7eb','#111444', '#e3eaef', '#32c861']);

        //creating 3d pie chart
        $this.createPieChart($('#pie-3d-chart')[0], pie_data, ['#2d7bf4','#4eb7eb','#111444', '#e3eaef', '#32c861'], true, false);
        ...
        $this.createPieChart($('#3d-exploded-chart')[0], sliced_Data, ['#2d7bf4','#4eb7eb','#111444', '#e3eaef', '#32c861',"#353d4a"], true, true);

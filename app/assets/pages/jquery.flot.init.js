...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#111444','#2d7bf4','#f1556c'];
		...
		var colors = ['#111444','#2d7bf4','#e3eaef','#f1556c',"#f9bc0b"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#111444']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#111444','#2d7bf4','#e3eaef','#f1556c',"#f9bc0b"];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#111444','#2d7bf4','#f1556c'], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ['#111444','#e3eaef'], line_data);
	},
